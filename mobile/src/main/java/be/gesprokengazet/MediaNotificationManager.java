...
import be.gesprokengazet.ui.MusicPlayerActivity;
import be.gesprokengazet.utils.LogHelper;
import be.gesprokengazet.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private static final String CHANNEL_ID = "be.gesprokengazet.MUSIC_CHANNEL_ID";

    private static final int NOTIFICATION_ID = 412;
    private static final int REQUEST_CODE = 100;

    public static final String ACTION_PAUSE = "be.gesprokengazet.pause";
    public static final String ACTION_PLAY = "be.gesprokengazet.play";
    public static final String ACTION_PREV = "be.gesprokengazet.prev";
    public static final String ACTION_NEXT = "be.gesprokengazet.next";
    public static final String ACTION_STOP = "be.gesprokengazet.stop";
    public static final String ACTION_STOP_CASTING = "be.gesprokengazet.stop_cast";
