 ...
 */
package be.gesprokengazet.ui.tv;
...
public class TvBrowseActivity extends FragmentActivity
    ...
    public static final String SAVED_MEDIA_ID="be.gesprokengazet.MEDIA_ID";
    public static final String BROWSE_TITLE = "be.gesprokengazet.BROWSE_TITLE";
